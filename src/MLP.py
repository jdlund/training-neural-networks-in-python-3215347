...
# Challenge: Finish the set_weights() and run() methods:
    ...
    def run(self, x):
        ...
        self.values[0] = x  # Input layer (layer=0) gets initial input
...
network = MultiLayerPerceptron([2, 2, 1])
...
print("--Setting Weights for XOR-gate--")
network.set_weights([[nand_weights, or_weights], [and_weights]])
network.print_weights()

print("--Testing XOR-gate MLP Functionality--")
